...
let AppController = class AppController {
    ...
    getNotifications(authUserId, data) {
        const { skip, limit } = data;
        this.appService.getUserNotifications(authUserId, skip, limit);
    }
};
__decorate([
    (0, microservices_1.EventPattern)('send_notification'),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AppController.prototype, "sendNotification", null);
__decorate([
    (0, common_1.Get)('/notifications'),
    __param(0, (0, user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, dtos_1.GetNotificationDto]),
    __metadata("design:returntype", void 0)
